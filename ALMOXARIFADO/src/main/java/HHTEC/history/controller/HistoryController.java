...
public class HistoryController {
    ...
    public ResponseEntity<History> entryHistory(@RequestBody HistoryDto historyDto) {
        ...
        History history = new History(historyDto.getNameProduct(), historyDto.getColaboratorName(), historyDto.getState());
    ...
    public ResponseEntity<History> editStatus(@RequestBody UpdateDto update) {
        ...
        Optional<History> result = historyService.mudarStatus(update.getId(),update.getColaborattorName(), update.getState());
